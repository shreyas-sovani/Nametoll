...
A successful settle prints a HashScan URL (`https://hashscan.io/testnet/tx/<id>`). Live testnet settles are in `docs/working-notes.md`.
...
Later: HCS bill, live Graph merchandise, ENSv2 directory, CRE TEE. See `docs/PRD.md` and `docs/BACKLOG.md`.
